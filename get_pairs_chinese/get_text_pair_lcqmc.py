...
if __name__ == "__main__":
    corpus_folder = r"E:\job\myitem\writting\text_data_enhancement\corpus\LCQMC"
    raw_file_name = ["train.txt", "dev.txt", "test.txt"]
    save_folder = r"E:\job\myitem\writting\text_data_enhancement\corpus\rephrase_corpus"
